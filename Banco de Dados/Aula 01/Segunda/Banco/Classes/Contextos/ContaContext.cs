...
namespace Banco.Classes.Contextos
{
    ...
    {
        //Propriedade - Representa as contas no banco de dados
        public DbSet<Conta> Contas { get; set; }
        //Métodos
        protected override void OnConfiguring(DbContextOptionsBuilder opcoesDeConstrucao)
        {
            string config = @"Server=ECFP507D1319388\SQLEXPRESS03;Database=BancoDBContas;Trusted_Connection=True;TrustServerCertificate=True";
